...
@NoArgsConstructor
@AllArgsConstructor
@Schema(name = "DiplomaPrintDataResponse", description = "Official diploma print data returned as JSON for SPA-side PDF generation")
public class DiplomaPrintDataResponse {
    ...
    private UUID userId;
    @Schema(description = "Full name resolved from IAM for official print output", example = "Ana Maria Lopez")
    private String userFullName;
    @Schema(description = "Congress identifier (UUID)", example = "9470bdea-8e37-4d0e-b2ae-545211ec4498")
    ...
    @Schema(description = "Diploma issue timestamp (ISO-8601 date-time)", example = "2026-10-10T10:00:00Z")

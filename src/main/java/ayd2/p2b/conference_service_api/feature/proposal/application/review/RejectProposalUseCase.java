...
@Component
@Transactional
public class RejectProposalUseCase {
    ...
    public ProposalResponse execute(UUID proposalId, ProposalRequesterContext requester) {
        ...
        Proposal rejected = proposal.reject(requester.getUserId(), OffsetDateTime.now());
        rejected.validateInvariants();
        Proposal saved = proposalRepositoryPort.save(rejected);

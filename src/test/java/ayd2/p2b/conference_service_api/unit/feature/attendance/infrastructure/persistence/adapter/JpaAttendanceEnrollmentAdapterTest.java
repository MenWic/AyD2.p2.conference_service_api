...
import ayd2.p2b.conference_service_api.feature.attendance.infrastructure.persistence.adapter.JpaAttendanceEnrollmentAdapter;
...
class JpaAttendanceEnrollmentAdapterTest {

    @Mock
    private EnrollmentJpaRepository enrollmentJpaRepository;

    private JpaAttendanceEnrollmentAdapter adapter;

    @BeforeEach
    void setUp() {
        adapter = new JpaAttendanceEnrollmentAdapter(enrollmentJpaRepository);
    }
